  ...
  return (
    <div className='qna-parent'>
      <div className='qna-div'>
          ...
          <p><mark>Ans: </mark>React is one of the most popular library of JavaScript. React mainly component based front end library. React application is made of multiple components. React create a virtual dom which do compare with dom tree. where is change by user react change only that element and set on dom tree.</p>
